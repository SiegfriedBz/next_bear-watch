    ...
    <>
      ...
      <PageLayout>
        ...
        <p>
          ...
          adventurers with a tool that can make their wilderness experiences
        ...
        <ul>
          <li>
            ...
            <p>
              Bear Watch is not intended for real-world or commercial use. It
              has been developed to showcase web development skills and may not
              have the full range of features or security measures found in
          ...
          <li>
            <h3>Data Handling</h3>
            <p>
              Bear Watch may not adhere to the same rigorous security and
              privacy standards as production apps. Use this app with the
              understanding that it may not meet the same data protection and
              privacy practices required for operational applications.
            </p>
          </li>
          <li>
            <h3>No Guarantee</h3>
            <p>
              ...
              its services. The use of the app is at your own risk, and we do
              not accept liability for any consequences of using the app.
            </p>
          </li>
          <li>
